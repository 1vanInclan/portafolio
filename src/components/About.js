        ...
        <div className='flex flex-col xl:flex-row gap-24'>
            ...
            <div className='flex flex-col items-center text-center lg:items-start lg:text-center mb-10 '>
                <div className='flex flex-col'>
                    ...
                    <br/>
                    Actualmente me encuentro en proceso de obtener mi título como Ingeniero. Sin embargo, no he dejado de capacitarme y aprender cosas nuevas, de mantenerme en constante actualización, que potenciadas con lo que aprendí en la facultad, puedo asegurar que soy una persona muy capáz de afrontar cualquier desafío.
                    <br/>
